...
p6 = Product.create(name: " MSI GeForce RTX 3080 VENTUS 3X 10G", price: 699, description: "Cooling System: Triple Fan, Boost Clock Speed: 1710 MHz, GPU Memory Size: 10 GB", image_url: "https://assets.nvidia.partners/images/png/RTX-3080-VENTUS-3X-10G.png")
p7 = Product.create(name: " NVIDIA GEFORCE RTX 3080", price: 699, description: "Cooling System: Fan, Boost Clock Speed: 1.71 GHz, GPU Memory Size: 10 GB", image_url: "https://assets.nvidia.partners/images/png/nvidia-geforce-rtx-3080.png")
p8 = Product.create(name: " NVIDIA GEFORCE RTX 3080 Ti", price: 1199, description: "Cooling System: Fan, Boost Clock Speed: 1.67 GHz, GPU Memory Size: 12 GB", image_url: "https://assets.nvidia.partners/images/png/3080-ti-back-300x198.png")
p9 = Product.create(name: " EVGA GeForce RTX 3080 XC3 Black", price: 819, description: "Cooling System: iCX3, Boost Clock Speed: 1710 MHz, GPU Memory Size: 10 GB", image_url: "https://assets.nvidia.partners/images/png/10G-P5-3881-KR.png")
